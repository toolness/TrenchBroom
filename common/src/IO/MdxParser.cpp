...
namespace TrenchBroom {
    namespace IO {
        ...
        MdxParser::MdxParser(const std::string& name, const char* begin, const char* end, const FileSystem& fs) :
        m_name(name),
        m_begin(begin),
        m_end(end),
        m_fs(fs) {}
        ...
        MdxParser::MdxFrame MdxParser::parseFrame(Reader reader, const size_t /* frameIndex */, const size_t vertexCount) {
        ...
        MdxParser::MdxMeshList MdxParser::parseMeshes(Reader reader, const size_t /* commandCount */) {
            MdxMeshList meshes;
